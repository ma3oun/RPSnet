...
class Learner:
    def __init__(
        ...
        self.optimizer = optim.SGD(
            trainable_params, lr=self.args.lr, momentum=0.96, weight_decay=0
        )
    ...
    def learn(self):
        ...
        if self.args.evaluate:
            ...
            print(
                " Test Loss:  %.8f, Test Acc:  %.2f" % (self.test_loss, self.test_acc)
            )
            return
        ...
        for epoch in range(self.args.start_epoch, self.args.epochs):
            ...
            print(
                ...
                % (epoch + 1, self.args.epochs, self.state["lr"], self.args.sess)
            )
    ...
    def train(self, epoch, path, last):
        ...
        for batch_idx, (inputs, targets) in enumerate(self.trainloader):
            ...
            if self.args.sess > 0:
                ...
                t_one_hot[
                    :, 0 : self.args.class_per_task * self.args.sess
                ] = outputs_old[:, 0 : self.args.class_per_task * self.args.sess]
